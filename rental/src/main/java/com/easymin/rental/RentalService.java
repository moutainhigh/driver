...
public interface RentalService {
     ...
     * @return
     */
    @GET("api/v1/rental/driver/order/{id}")
    Observable<OrderResult> findOne(@Path("id") Long id);
     ...
     */
    @FormUrlEncoded
    @PUT("api/v1/rental/driver/order/status")
     ...
     */
    @FormUrlEncoded
    @PUT("api/v1/rental/driver/order/confirm")
