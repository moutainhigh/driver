...
//        }
        ...
        LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT,
                DensityUtil.dp2px(getContext(),25));
        ...
        hintViewText.setPadding(DensityUtil.dp2px(getContext(),10), 0, DensityUtil.dp2px(getContext(),10), 0);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        int hintViewWidth = DensityUtil.dp2px(getContext(), 250);
        int hintViewHeight =DensityUtil.dp2px(getContext(),25);

        int hintViewLeft = (getWidth() - hintViewWidth) / 2;
        int hintViewTop = maskView.getFrameRect().bottom + DensityUtil.dp2px(getContext(),16);
