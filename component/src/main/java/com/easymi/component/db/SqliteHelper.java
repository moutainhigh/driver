...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    private void createDriverInfoTable(SQLiteDatabase db) {
        sqlBuf.append("CREATE TABLE ").append("t_driverinfo").append(" (")
                ...
                .append("emergencyPhone").append(" ").append("TEXT").append(",")
                .append("licensingTime").append(" ").append("LONG").append(",")
                .append("driveLicenceStart").append(" ").append("INTEGER").append(",")
                ...
                .append("created").append(" ").append("LONG").append(",")
                .append("updated").append(" ").append("LONG").append(",")
                .append("idcardPath").append(" ").append("TEXT").append(",")
                .append("homeAddress").append(" ").append("TEXT").append(",")
                .append("driveLicensePath").append(" ").append("TEXT").append(",")
                .append("driveLicenseType").append(" ").append("TEXT").append(",")
                .append("drivingLicensePath").append(" ").append("TEXT").append(",")
                .append("remark").append(" ").append("TEXT").append(",")
                .append("appVersion").append(" ").append("TEXT").append(",")
                .append("driverType").append(" ").append("LONG").append(",")
                .append("deviceNo").append(" ").append("TEXT").append(",")
                .append("deviceType").append(" ").append("TEXT").append(",")
                .append("fullBodyPath").append(" ").append("TEXT").append(",")
                .append("height").append(" ").append("TEXT").append(",")
                .append("originPlace").append(" ").append("TEXT").append(",")
                .append("motorNo").append(" ").append("TEXT").append(",")
                .append("nationality").append(" ").append("TEXT").append(",")
                .append("networkTaximanNo").append(" ").append("TEXT").append(",")
                .append("nation").append(" ").append("TEXT").append(",")
                .append("maritalStatus").append(" ").append("TEXT").append(",")
                .append("foreignLanguageLevel").append(" ").append("TEXT").append(",")
                .append("email").append(" ").append("TEXT").append(",")
                .append("education").append(" ").append("TEXT").append(",")
                .append("networkTaximanLicenseDate").append(" ").append("INTEGER").append(",")
                .append("licenseOrganization").append(" ").append("TEXT").append(",")
                .append("trafficViolationTimes").append(" ").append("INTEGER").append(",")
                .append("contractStart").append(" ").append("INTEGER").append(",")
                .append("contractEnd").append(" ").append("INTEGER").append(",")
                .append("isCruisingTaxiDrivers").append(" ").append("INTEGER").append(",")
                .append("driverServiceOperator").append(" ").append("TEXT").append(",")
                .append("mapType").append(" ").append("TEXT").append(",")
                .append("idcardBackPath").append(" ").append("TEXT").append(",")
                .append("mobileModel").append(" ").append("TEXT").append(",")
