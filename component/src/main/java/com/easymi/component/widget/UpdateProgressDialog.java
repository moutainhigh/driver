...
public class UpdateProgressDialog extends AlertDialog {
    ...
    /**
     * Creates a UpdateProgressDialog with a circular, spinning progress
     * bar. This is the default.
     */
    public static final int STYLE_SPINNER = 0;

    /**
     * Creates a UpdateProgressDialog with a horizontal progress bar.
     */
    ...
    /**
     * Creates and shows a UpdateProgressDialog.
     *
     * @param context the parent context
     * @param title   the title text for the dialog's window
     * @param message the text to be displayed in the dialog
     * @return the UpdateProgressDialog
     */
    public static UpdateProgressDialog show(Context context, CharSequence title,
    ...
    public static UpdateProgressDialog show(Context context, CharSequence title,
        ...
        UpdateProgressDialog dialog = new UpdateProgressDialog(context);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            ...
            View view = inflater.inflate(R.layout.cus_progress_dialog_1, null);
    ...
    /**
     * Change the indeterminate mode for this UpdateProgressDialog. In indeterminate
     * mode, the progress is ignored and the dialog shows an infinite
     * animation instead.
     * <p>
     * <p><strong>Note:</strong> A UpdateProgressDialog with style {@link #STYLE_SPINNER}
    ...
    /**
     * Whether this UpdateProgressDialog is in indeterminate mode.
     *
    ...
    /**
     * Sets the style of this UpdateProgressDialog, either {@link #STYLE_SPINNER} or
     ...
     *
     * @param style the style of this UpdateProgressDialog, either {@link #STYLE_SPINNER} or
