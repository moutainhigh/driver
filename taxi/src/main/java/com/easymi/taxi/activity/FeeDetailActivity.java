...
//        taxiOrder = (TaxiOrder) getIntent().getSerializableExtra("taxiOrder");
//        if (dymOrder == null || taxiOrder == null) {
//            finish();
//            return;
//        }
//
...
//
//        if (taxiOrder.coupon != null && (taxiOrder.coupon.couponType == 1 || taxiOrder.coupon.couponType == 2)) {
//            if (taxiOrder.coupon.couponType == 2) {
//                couponType.setText("（" + taxiOrder.coupon.deductible + getString(R.string.xianjin_coupon) + "）");
//            } else {
//                DecimalFormat df = new DecimalFormat("#0.0");
//                couponType.setText("（" + df.format(taxiOrder.coupon.discount / 10) + getString(R.string.zhekou_coupon) + "）");
//            }
