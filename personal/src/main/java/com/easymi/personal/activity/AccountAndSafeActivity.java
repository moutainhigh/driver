...
import com.easymi.component.faceCheck.RegisterAndRecognizeActivity;
...
public class AccountAndSafeActivity extends RxBaseActivity {
    ...
    public void initViews(Bundle savedInstanceState) {
        ...
        findViewById(R.id.ll_face_check).setOnClickListener(v -> startActivity(new Intent(this,RegisterAndRecognizeActivity.class)));
    }
