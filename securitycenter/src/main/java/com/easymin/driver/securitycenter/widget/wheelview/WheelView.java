package com.easymin.driver.securitycenter.widget.wheelview;
...
import com.easymin.driver.securitycenter.widget.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    public void setLineColor(int color) {
        ...
        centerRectPaint.setColor(lineColor);
    }

    public void setLineWidth(float width) {
        this.lineWidth = width;
        centerRectPaint.setStrokeWidth(lineWidth);
    }
    ...
    private void initData(Context context) {
        ...
        centerRectPaint.setColor(lineColor);
        centerRectPaint.setStrokeWidth(2f);
        setClickable(true);
...
//        setBackgroundResource(wheelBackground);
    ...
    private void drawShadows(Canvas canvas) {
        ...
        int height = count * getItemHeight();   //半个背景的高度
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        //绘制上面线
        canvas.drawLine(0, center - offset, getWidth(), center - offset, centerRectPaint);
        //绘制下面线
        canvas.drawLine(0, center + offset, getWidth(), center + offset, centerRectPaint);
    }
