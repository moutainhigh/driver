...
//            setUpMap();
    ...
    private void drawPolygon(GeoFence fence) {
        ...
        for (List<DPoint> subList : pointList) {
            ...
            polygonOption.strokeColor(Color.BLUE).fillColor(R.color.color_8cb4ef).strokeWidth(3);
            ...
            public void onCameraChangeFinish(CameraPosition cameraPosition) {
                if (mMapPosList.size() != 1){
                    ...
                    if (isIn) {
                        ...
                        mConfirmPosBtn.setBackgroundResource(R.drawable.shape_button_blue);
                    } else {
    ...
    private void addMarkersToMap() {
        ...
        Marker screenMarker = mAMap.addMarker(new MarkerOptions().title("")
                .anchor(0.5f, 1f)
                .icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_mark_position)));
